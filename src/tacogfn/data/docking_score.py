...
class CrossDockDockingScoreDataset(Dataset):
    def __init__(
        self,
        pocket_ligand_affinity: list[tuple[str, str, float]], # [(pocket_id, ligand_smiles, docking_score)]
    ...
    def processed_file_names(self):
        return [f'pdb_ids_{self.dataset_type}.pt', f'ligand_features_{self.dataset_type}.pt', 
    ...
    def get(self, idx):
        ...
        pharmacophore_graph = self.pharmacophore_db.get_pharmacophore_data_from_id(
            pocket_id)
        return {
